...
pub fn run() -> Result<(), failure::Error> {
    ...
    let mut inner_radius_uniform = R32FUniformBuffer::new(&gl, 2);
    inner_radius_uniform.add_data(0.05);
    inner_radius_uniform.send_to_shader_property(&renderer.program(), "inner_radius_buffer");
...
pub fn quad(res: &resources::Resources, gl: &gl::Gl)
    ...
    let points: Vec<QuadShapeVertex> = vec![
        ...
        QuadShapeVertex::with_position_and_size((900.0, 700.0).into(), (1400.0, 1400.0).into(), (0.0, 0.0, 0.0).into())
    ];
